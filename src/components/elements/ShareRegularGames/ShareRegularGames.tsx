...
interface ShareRegularGamesProps {
  shareId: string;
}

const ShareRegularGames: FC<ShareRegularGamesProps> = ({ shareId }) => {
              ...
              <div className="mt-5 w-full md2:mt-10">
                {data?.shareTournament.tournament.type === "TEAMS" ? (
                  ...
                  <GroupParticipantCard
                    participants={data?.shareTournament.tournament.teams || []}
                  />
                )}
              </div>
            </div>
...
export default ShareRegularGames;
