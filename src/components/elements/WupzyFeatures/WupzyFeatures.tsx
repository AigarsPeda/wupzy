...
const WupzyFeatures = () => {
  return (
    <div className="mx-auto mt-16 max-w-4xl md:mt-32">
      <p className="mb-8 text-lg text-gray-600 md:mb-16">
        Plus, Wupzy&apos;s user-friendly interface and responsive design make it
        easy to create, manage, and view tournament tables on any device,
        whether you&apos;re using a desktop computer or a mobile phone. So, you
        can enjoy the full range of features and functionality on the go, no
