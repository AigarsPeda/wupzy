  ...
  return (
    <button
      ...
      className={classNames(
        ...
        color === "dark" && "bg-gray-950 text-white hover:bg-gray-950",
        ...
        "inline-flex items-center justify-center whitespace-nowrap rounded-md px-4 py-2 text-sm font-medium transition-all duration-200 ease-in-out"
      )}
    >
      {isLoading ? (
