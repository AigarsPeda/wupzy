  ...
  (
    ...
    <button
      ...
      className={classNames(
        ...
        "relative flex min-w-[5.8rem] items-center justify-center rounded-md text-center shadow transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-gray-100",
        fontSize === "sm" && "text-sm",
