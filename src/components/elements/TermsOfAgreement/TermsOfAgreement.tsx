...
const TermsOfAgreement: FC = () => {
  return (
    <div className="mt-10">
      ...
      <p className="mb-4">Last updated: April 30, 2023</p>
      <p className="font-semibold text-gray-900">
        Welcome to Wupzy, a platform that allows you to create and manage
        tournaments. By accessing or using our website, you agree to be bound by
        the following terms and conditions. Please read these terms carefully
        before using our website. If you do not agree with these terms, you
        should not use our website. Your continued use of our website
        constitutes your acceptance of these terms and any modifications
        thereof.
      </p>
      ...
      <ul className=" text-gray-900">
        <li className="my-2 font-normal text-gray-900">
          ...
          Cookies are used to remember user preferences and settings, such as
      ...
      <ul>
        ...
        <li className="my-2 font-normal text-gray-900">
          ...
          hateful, or racially, ethnically, or otherwise objectionable. c. To
          impersonate or attempt to impersonate Wupzy, a Wupzy employee, another
          user, or any other person or entity. d. To engage in any conduct that
          is harmful to minors in any way. e. To transmit, or procure the
          sending of, any advertising or promotional material without our prior
          written consent, including any &quot;junk mail,&quot; &quot;chain
          letter,&quot; &quot;spam,&quot; or any other similar solicitation. f.
          To interfere with or attempt to interfere with the proper working of
          the Wupzy platform, including any activity that disrupts, diminishes
          the quality of, interferes with the performance of, or impairs the
          functionality of, the Wupzy platform. g. To attempt to bypass or
          circumvent measures we may use to prevent or restrict access to the
          Wupzy platform. h. To use any robot, spider, or other automatic
          device, process, or means to access the Wupzy platform for any
        ...
        <li className="my-2 font-normal text-gray-900">
          ...
          suspending or terminating your access to the Wupzy platform, reporting
          you to law enforcement authorities, and disclosing any information
          necessary or appropriate to such authorities relating to your use of
          the Wupzy platform. We also reserve the right to take any other legal
          action we deem necessary or appropriate.
        </li>
      </ul>
      ...
      <ul>
        <li className="my-2 font-normal text-gray-900">
          ...
          and complete. You are solely responsible for safeguarding the password
          and any other login credentials associated with your account and for
          any activity or actions that occur under your account. We encourage
          you to use a strong and unique password, to not disclose your password
        ...
        <li className="my-2 font-normal text-gray-900">
          ...
          information associated with your account. We also reserve the right to
        ...
        <li className="my-2 font-normal text-gray-900">
          ...
          that occurs under your account, including any content that you submit,
      ...
      <ul>
        ...
        <li className="my-2 font-normal text-gray-900">
          ...
          users grant Wupzy a non-exclusive, transferable, sub-licensable,
          ...
          (including in connection with the Wupzy platform and Wupzy&apos;s
        ...
        <li className="my-2 font-normal text-gray-900">
          ...
          please follow the procedures set forth in our Digital Millennium
          Copyright Act (DMCA) Notice and Takedown Policy.
        </li>
      </ul>
      <p className="mb-2 mt-5 text-lg font-bold text-gray-900">
      ...
      <ul>
        <li className="my-2 font-normal text-gray-900">
          ...
          or any other warranty that may arise under any law. Wupzy does not
        ...
        <li className="my-2 font-normal text-gray-900">
          ...
          other intangible losses (even if Wupzy has been advised of the
        ...
        <li className="my-2 font-normal text-gray-900">
          ...
          modification, suspension, or termination of the platform.
        </li>
      </ul>
